  ...
  return (
    <>
      <nav className="sticky top-0 z-40 w-full border-b border-gray-200 bg-white backdrop-blur-md dark:border-gray-800 dark:bg-gray-950/90">
        <div className=" border-b border-gray-200 bg-white backdrop-blur-md dark:border-gray-800 dark:bg-gray-950/90">
          <div className="container-custom">
            <div className="flex h-16  items-center justify-between w-full">
              ...
              <div className="flex items-center gap-2 md:gap-10">
                ...
                >
                  <h4 className="leading-none">Sunam</h4>
                  <h4 className="text-gray-900 dark:text-white">.shop</h4>
                </Link>
                <div
                ...
                >
                  <input
                    ...
                    className="w-full rounded-lg border border-gray-300 bg-gray-50 py-2 pl-4 pr-10 text-sm focus:border-[#3B82F6] focus:outline-none focus:ring-1 focus:ring-[#3B82F6] dark:border-gray-700 dark:bg-gray-900 dark:text-white"
                  />

                  <div
                    onClick={handleSearch}
                    className="absolute right-1 top-1/2 -translate-y-1/2 primaryButton px-2 py-1 rounded-lg flex items-center justify-center cursor-pointer space-x-2"
                  >
              ...
              <div className="hidden lg:flex items-center gap-6">
                {categories.map((cat) => (
                  <Link
                    key={cat.id}
                    href={cat.link}
                    className="relative text-[15px] font-medium text-[#0F172A] hover:text-[#1E293B]
                    after:content-[''] after:absolute after:left-1/2 after:-bottom-1 after:h-[2px]
                    after:w-0 after:bg-[#1E293B] after:transition-all after:duration-500
